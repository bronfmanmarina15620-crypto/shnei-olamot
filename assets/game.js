(function () {
  ...
  function introScreen() {
    ...
    const body = hall === "hot"
      ? "לפעמים קורה משהו, ואת כועסת.<br><br>נקרא סיפור.<br>את בוחרת מה לעשות.<br>אפשר יותר מאחד."
      : "לפעמים קשה להגיד מה את רוצה.<br><br>נקרא סיפור.<br>את בוחרת מה להגיד.<br>אפשר יותר מאחד.";
    el(
      '<div class="panel">' +
      '<p class="sub">' + title + '</p>' +
      '<h1>היי ' + name + '</h1>' +
  ...
  function toolsScreen() {
    ...
    el(
      ...
      '<p class="tiny">לחצי על מה שמתאים. אפשר כמה.</p>' +
